package com.example.assnetworking.model;
...
public class Galleries {
    ...
    public Galleries(String galleryId, String url, Integer countPhotos, Integer countViews) {
    ...
    public Galleries(Integer countPhotos, Integer countViews) {
        this.countPhotos = countPhotos;
        this.countViews = countViews;
    }
